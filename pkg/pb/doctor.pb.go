...
var file_pkg_pb_doctor_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x64, 0x6f, 0x63, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x32, 0xd0, 0x02, 0x0a, 0x06, 0x44,
	...
	0x74, 0x6f, 0x72, 0x73, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x72, 0x22, 0x00, 0x42, 0x0a, 0x5a,
...
var file_pkg_pb_doctor_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_pkg_pb_doctor_proto_depIdxs = []int32{
	...
	9, // 6: doctor.Doctor.IndividualDoctor:input_type -> doctor.Doid
	6, // 7: doctor.Doctor.DoctorProfile:input_type -> doctor.Do_id
	2, // 8: doctor.Doctor.DoctorSignUp:output_type -> doctor.DoctorSignUpResponse
	4, // 9: doctor.Doctor.DoctorLogin:output_type -> doctor.DoctorLoginResponse
	8, // 10: doctor.Doctor.DoctorsDetail:output_type -> doctor.DoctorsDetailre
	7, // 11: doctor.Doctor.IndividualDoctor:output_type -> doctor.DoctorsDetailr
	7, // 12: doctor.Doctor.DoctorProfile:output_type -> doctor.DoctorsDetailr
